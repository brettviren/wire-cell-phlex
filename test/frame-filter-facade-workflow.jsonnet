{
  ...
  //   1. wcp_wire_schema_source loads a real wire geometry file once at the
  //      job layer and produces a wcphlex::WireSchema product.
  //   2. wcp_frame_source produces synthetic frames at the event layer.
  //   3. wcp_frame_filter (use_wire_schema: true) consumes both products.
  ...
  //   4. wcp_frame_observer asserts the output Frame is non-null.
  //
