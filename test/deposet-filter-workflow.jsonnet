{
  ...
  // wcp_deposet_filter wraps DepoSetFilter backed by deposet-passthrough.jsonnet,
  // which routes each DepoSet straight through (identity transform).
  // wcp_deposet_observer asserts the output DepoSet is non-null for every event.
  //
