...
# Full drift + electronics sim: reads muon-depos.npz, writes sim-frames.npz
phlex -c build/deposet-sim-workflow.jsonnet       # generated by CMake

# Signal processing only: reads sim-frames.npz, writes sp-frames-a.npz
phlex -c build/frame-sigproc-workflow.jsonnet     # generated by CMake

# Combined sim + signal processing: reads muon-depos.npz, writes sp-frames-b.npz
phlex -c build/deposet-sim-sigproc-workflow.jsonnet  # generated by CMake

# PDHD 4-APA fan-out/fan-in: reads muon-depos.npz, writes fans-frames.npz
phlex -c build/fans-workflow.jsonnet                 # generated by CMake

# Per-APA sigproc debug tests (APAs 0-2 pass; APA 3 currently crashes)
phlex -c build/pdhd-apa0-sigproc-workflow.jsonnet    # generated by CMake
phlex -c build/pdhd-apa1-sigproc-workflow.jsonnet    # generated by CMake
phlex -c build/pdhd-apa2-sigproc-workflow.jsonnet    # generated by CMake
phlex -c build/pdhd-apa3-sigproc-workflow.jsonnet    # generated by CMake (crashes)

# 4-APA fan with full sigproc: fails until apa_ident=3 crash is fixed
phlex -c build/fans-sigproc-workflow.jsonnet         # generated by CMake
```

Note: the identity, drifter, and sim workflows use file paths injected by CMake's
...
See `docs/second-real-job.md` for the DepoTransform simulation pipeline and FrameSinkFile.
See `docs/third-real-job.md` for OmnibusSigProc signal processing (standalone and combined variants).
See `docs/fans-job.md` for the PDHD 4-APA fan-out/fan-in pipeline.
